...
export const hu: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'Ennek az artifactnak még nincsenek {tag} annotációi — kérd meg az ügynököt, hogy adja hozzá azokat a szakaszokhoz, amelyeket vizsgálni szeretnél.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'Ennek az artifactnak még nincsenek {tag} annotációi — kérd meg az ügynököt, hogy adja hozzá azokat a szakaszokhoz, amelyekhez megjegyzést szeretnél fűzni.',
