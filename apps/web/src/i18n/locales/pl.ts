...
export const pl: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'Ten artefakt nie ma jeszcze adnotacji {tag} — poproś agenta o dodanie ich do sekcji, które chcesz sprawdzić.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'Ten artefakt nie ma jeszcze adnotacji {tag} — poproś agenta o dodanie ich do sekcji, które chcesz skomentować.',
