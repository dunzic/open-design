...
export const tr: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'Bu artifact henüz {tag} ek açıklamalarına sahip değil — incelemek istediğiniz bölümlere eklemesi için ajandan isteyin.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'Bu artifact henüz {tag} ek açıklamalarına sahip değil — yorum yapmak istediğiniz bölümlere eklemesi için ajandan isteyin.',
  ...
  'pet.railAria': 'Evcil dost seçici',
  'pet.railTitle': 'Evcil Dostlar',
  'pet.railHint': 'Çalışma alanının üstünde süzülecek bir yoldaş seç.',
  'pet.railExpand': 'Seçiciyi göster',
  'pet.railCollapse': 'Seçiciyi daralt',
  'pet.railHide': 'Pet seçiciyi gizle',
  'pet.railShow': 'Pet seçiciyi göster',
  'pet.railCustomFlavor': 'Kendi dostun — ad, simge ve renk.',
  'pet.railCustomize': 'Özelleştir…',
