...
export const fr: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'Cet artefact n’a pas encore d’annotations {tag} — demandez à l’agent de les ajouter aux sections que vous voulez inspecter.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'Cet artefact n’a pas encore d’annotations {tag} — demandez à l’agent de les ajouter aux sections que vous voulez commenter.',
  ...
  'settings.orbit.lede': 'Collecte l’activité des connecteurs selon un calendrier et publie le résultat sous forme de live artifact actualisable.',
  ...
  'settings.orbit.artifactMetaLegacy': 'Généré avant l’activation de la prise en charge de live artifact — relancez Orbit pour en publier un.',
  ...
  'liveArtifact.viewer.code.renderedHelp': 'Le index.html généré actuellement chargé par l’aperçu.',
