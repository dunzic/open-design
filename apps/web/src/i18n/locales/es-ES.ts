...
export const esES: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'Este artefacto aún no tiene anotaciones {tag} — pídele al agente que las añada a las secciones que quieras inspeccionar.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'Este artefacto aún no tiene anotaciones {tag} — pídele al agente que las añada a las secciones que quieras comentar.',
