...
export const fa: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'این محصول هنوز حاشیه‌نویسی {tag} ندارد — از عامل بخواهید آن را به بخش‌هایی که می‌خواهید بررسی کنید اضافه کند.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'این محصول هنوز حاشیه‌نویسی {tag} ندارد — از عامل بخواهید آن را به بخش‌هایی که می‌خواهید نظر بدهید اضافه کند.',
