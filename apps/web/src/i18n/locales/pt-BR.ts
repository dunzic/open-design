...
export const ptBR: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'Este artefato ainda não tem anotações {tag} — peça ao agente para adicioná-las às seções que você quer inspecionar.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'Este artefato ainda não tem anotações {tag} — peça ao agente para adicioná-las às seções que você quer comentar.',
