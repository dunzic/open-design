...
export const ar: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'لا يحتوي هذا المنتج على تعليقات {tag} بعد — اطلب من الوكيل إضافتها إلى الأقسام التي تريد فحصها.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'لا يحتوي هذا المنتج على تعليقات {tag} بعد — اطلب من الوكيل إضافتها إلى الأقسام التي تريد التعليق عليها.',
