...
export const uk: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'У цього артефакту ще немає анотацій {tag} — попросіть агента додати їх до розділів, які ви хочете перевірити.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'У цього артефакту ще немає анотацій {tag} — попросіть агента додати їх до розділів, які ви хочете прокоментувати.',
