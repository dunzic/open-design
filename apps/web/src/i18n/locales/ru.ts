...
export const ru: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'У этого артефакта пока нет аннотаций {tag} — попросите агента добавить их в разделы, которые вы хотите проинспектировать.',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'У этого артефакта пока нет аннотаций {tag} — попросите агента добавить их в разделы, которые вы хотите прокомментировать.',
