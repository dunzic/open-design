...
export const ko: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': '이 아티팩트에는 아직 {tag} 주석이 없습니다 — 검사하려는 영역에 에이전트가 추가해 주도록 요청하세요.',
  'fileViewer.inspectEmptyHint.noTargetsComment': '이 아티팩트에는 아직 {tag} 주석이 없습니다 — 댓글을 남기려는 영역에 에이전트가 추가해 주도록 요청하세요.',
