...
export const th: Dict = {
  ...
  'newproj.imageStyleLabel': 'สไตล์',
  'newproj.imageStylePlaceholder': 'ภาพถ่ายแนวบทความ แสงธรรมชาติ',
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'อาร์ติแฟกต์นี้ยังไม่มีคำอธิบาย {tag} — ขอให้เอเจนต์เพิ่มลงในส่วนที่คุณต้องการตรวจสอบ',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'อาร์ติแฟกต์นี้ยังไม่มีคำอธิบาย {tag} — ขอให้เอเจนต์เพิ่มลงในส่วนที่คุณต้องการแสดงความคิดเห็น',
