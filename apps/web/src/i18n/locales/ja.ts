...
export const ja: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': 'このアーティファクトにはまだ {tag} の注釈がありません — 検査したい部分にエージェントへ追加を依頼してください。',
  'fileViewer.inspectEmptyHint.noTargetsComment': 'このアーティファクトにはまだ {tag} の注釈がありません — コメントしたい部分にエージェントへ追加を依頼してください。',
