...
export const zhTW: Dict = {
  ...
  'fileViewer.inspectEmptyHint.noTargetsInspect': '此產物尚未標註 {tag}，請讓代理為你想檢查的區塊加上這個屬性。',
  'fileViewer.inspectEmptyHint.noTargetsComment': '此產物尚未標註 {tag}，請讓代理為你想評論的區塊加上這個屬性。',
